...
<!-- Mirrored from shprenger.site/ak1/dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Jun 2019 18:13:13 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="row">
                    <div class="col col--sm-8 col--sm-offset-2 col--md-12 col--md-offset-0 col--lg-10 col--lg-offset-1">
                        <div class="row">
                            ...
                            <div class="col col--md-6">
                                <p class="home__welcome-content">It was a quiet summer morning. The sun stood already
                                    pretty high in the clear sky but the fields were still sparkling with dew; a fresh
                                    breeze blew fragrantly from the scarce awakened valleys and in the forest, still
                                    damp and hushed, the birds
            ...
            <div class="row">
                <div class="col col--sm-8 col--sm-offset-2 col--md-12 col--md-offset-0 col--lg-10 col--lg-offset-1">
                    <div class="row">
                        ...
                        <div class="col col--md-6">
                            <p class="home__about-content">The idea of beauty is the fundamental idea of everything. In
                                the world we see only distortions of the fundamental idea, but art, by imagination, may
                                lift itself to the height of this idea. Art is therefore akin to creation.</p>
                        </div>
                        <div class="col col--md-6">
                        ...
                        <div class="col">
                            <div class="home__blog-wrapper">
                                <a href="article.html" class="home__blog-preview">
                                    ...
                                    <p class="home__blog-preview-text">What does it take to be successful? Ask around
                                        and you will find different answers to the formula of success. The truth is,
                                        success leaves clues and you can achieve the success in the area you desire by
                                        observing the common qualities and principles.</p>
            ...
            <div class="row">
                <div class="col col--sm-8 col--sm-offset-2 col--md-12 col--md-offset-0 col--lg-10 col--lg-offset-1">
                    <div class="row">
                        ...
                        <div class="col col--md-6">
                            <p class="home__contacts-content">Have a questions, offers on cooperation?<br>Feel free to
                                contact me!</p>
                            <div class="home__contacts-info">
                                <p class="home__contacts-geo">Moscow, Russia</p>
                                <p class="home__contacts-mail"><a href="mailto:job@ak1.io" target="_top">job@ak1.io</a>
                                </p>
                        ...
                        <div class="col col--md-6">
                            ...
                            <form class="form" id="contact-form">
                                ...
                                <div class="row">
                                    <div class="col field">
                                        <input id="email" type="email" class="field__input field--email required"
                                               required>
                                ...
                                <div class="row">
                                    <div class="col field">
                                        <textarea id="text" class="field__textarea field--message required"
                                                  required></textarea>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="submit" class="btn form__btn form__btn--submit"
                                               value="Send message">
                                    </div>
                                </div>
                            </form>
...
<!-- Mirrored from shprenger.site/ak1/dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Jun 2019 18:13:35 GMT -->
</html>
